	...
	<section class="hero-section">
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<div class="hs-text">
						<h2>Selamat Datang Di Aplikasi E-Cuti PT. ABC</h2>
				...
				<div class="col-lg-6">
					<form class="hero-form">
						<input type="text" placeholder="Masukan Nip Pegawai">
		...
		<div class="hero-slider owl-carousel">
			<div class="hs-item set-bg" data-setbg="img/gedung_1.jpg"></div>
			<div class="hs-item set-bg" data-setbg="img/gedung_2.jpg"></div>
			<div class="hs-item set-bg" data-setbg="img/gedung_3.jpg"></div>
		</div>
	</section>
	<!-- Hero Section end -->
